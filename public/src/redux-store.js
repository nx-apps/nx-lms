...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_polymer_redux__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reducer_report__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reducer_import__ = __webpack_require__(51);
...
const rootReducer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* combineReducers */])({
    report:__WEBPACK_IMPORTED_MODULE_2__reducer_report__["a" /* reportReducer */],
    import:__WEBPACK_IMPORTED_MODULE_3__reducer_import__["a" /* importReducer */]
});
...
window.reportAction = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__reducer_report__["b" /* reportAction */])(storeApp);
window.importAction = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__reducer_import__["b" /* importAction */])(storeApp);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = importReducer;
/* harmony export (immutable) */ __webpack_exports__["b"] = importAction;
...
function importReducer(state = initState,action){
    switch (action.type){
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__axios__ = __webpack_require__(14);
/* harmony export (immutable) */ __webpack_exports__["a"] = reportReducer;
/* harmony export (immutable) */ __webpack_exports__["b"] = reportAction;
    ...
    return {
        EXPORT_SAVE_NAME:function(name){
            ...
            return new Promise((resolve,reject)=>{
                __WEBPACK_IMPORTED_MODULE_0__axios__["a" /* default */].post('./new/new',name)
                .then((response)=>{
                    console.log('success!!');
        ...
        EXPORT_EDIT_NAME:function(name){
            return new Promise((resolve,reject)=>{
                __WEBPACK_IMPORTED_MODULE_0__axios__["a" /* default */].put('./new/new',name)
                .then((response)=>{
                    console.log('success!!');
                    console.log(response.data);
                    resolve(response);
        ...
        EXPORT_DELETE_LIST:function(id){
            return new Promise((resolve,reject)=>{
                __WEBPACK_IMPORTED_MODULE_0__axios__["a" /* default */].delete('./new/new?id='+id)
                .then((response)=>{
                    console.log('success!!');
                    console.log(response.data);
                    resolve(response);
        ...
        EXPORT_GET_LIST:function(){
            __WEBPACK_IMPORTED_MODULE_0__axios__["a" /* default */].get('./new/new')
